...
# ---------- SCENES ----------
scenes = [
    {"file": "01_space_empty.jpg", "caption": "They told me space is empty… but they were wrong.", "duration": 5},
    {"file": "02_training.jpg", "caption": "Out here, every breath is borrowed… every second, earned. But emptiness teaches purpose.", "duration": 8},
    {"file": "03_sunrise.jpg", "caption": "When gravity no longer holds you… you realize — the only thing pulling you forward is your will.", "duration": 8},
    {"file": "04_tear.jpg", "caption": "Dreams aren’t made on solid ground. They’re forged in the silence between stars.", "duration": 8},
    {"file": "05_nebula.jpg", "caption": "If you ever feel lost in the dark… look up. The universe isn’t infinite — it’s inviting you to begin again.", "duration": 10}
]

# ---------- FUNCTION: GENERATE AMBIENT MUSIC ----------
def generate_ambient_music(duration_ms=60000):
    """Creates soft ambient tones for cinematic effect."""
